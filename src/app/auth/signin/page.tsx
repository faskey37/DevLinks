...
import { Eye, EyeOff, Loader2, Mail, ArrowRight, CheckCircle2, ShieldCheck, Sparkles } from "lucide-react";
      ...
      <div className="flex min-h-screen items-center justify-center bg-[#020408] px-6">
        <div className="w-full max-w-md text-center">
          ...
          <p className="mt-4 text-slate-400 leading-relaxed">
            We've dispatched a secure link to <span className="text-blue-400 font-bold">{verificationEmail}</span>.
          </p>
          <div className="mt-8 rounded-3xl border border-white/5 bg-white/[0.02] p-6 text-left backdrop-blur-xl">
             <div className="flex gap-4">
                ...
                <div>
                   ...
                   <p className="mt-1 text-sm text-slate-400">Verify your inbox to activate your developer profile.</p>
                </div>
             </div>
          </div>
          <button
        ...
        <div className="rounded-[2.5rem] border border-white/5 bg-white/[0.02] p-10 backdrop-blur-3xl shadow-2xl">
          ...
          <div className="mb-10 text-center">
            ...
            <h1 className="text-3xl font-black tracking-tighter text-white">
              {tab === "signin" ? "Nexus Gate" : "Ship Your Page"}
            </h1>
            <p className="mt-2 text-sm font-medium text-slate-500">
              {tab === "signin" ? "Welcome back to your dashboard" : "Join 10k+ developers today"}
            </p>
          </div>
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center">
              <span className="bg-[#0b0f1a] px-4 text-[10px] font-black uppercase tracking-[0.2em] text-slate-600">Secure Email Login</span>
            </div>
          </div>

          {/* Form Logic */}
          <form onSubmit={tab === "signin" ? signInForm.handleSubmit(handleSignIn) : signUpForm.handleSubmit(handleSignUp)} className="space-y-5">
            {tab === "signup" && (
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-2xl border border-white/5 bg-white/[0.02] px-5 py-3.5 pr-12 text-sm outline-none transition focus:border-blue-500/50 focus:bg-white/[0.05] focus:ring-4 focus:ring-blue-500/10"
                  placeholder="••••••••"
                />
